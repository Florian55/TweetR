...
abstract class AbstractAuthentification {
    ...
    abstract protected function updateSession($username, $level);
      ...
      *  - Mettre l'attribut $this->logged_in à faux
      * 
      */
     ...
     * @return bool : vrai si le niveaux requis est inférieur ou égale Ã  la 
     ...
     * @param integer: $level, le niveau d'accès de l'utilisateur stocké en BD
     *
     * Algorithme :
     *    
